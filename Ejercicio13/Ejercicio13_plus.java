...
public class Ejercicio13_plus {
	public static void main(String[] args) throws IOException 
	{
		...
		else
		{
			...
			JSONArray json = new JSONArray(salidaAPI);
			
			int random = (int)(Math.random()*10+1);
			
			JSONObject jo = new JSONObject(json.get(random).toString());
			
			
			String dirURL = jo.getString("url").toString();
